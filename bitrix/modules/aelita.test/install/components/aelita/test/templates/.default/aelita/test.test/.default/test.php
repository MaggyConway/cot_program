                    ...
                    <?foreach($arResult["ANSWER"][$Question["ID"]] as $Answer){?>
                        ...
                        <?if($Question["TEST_TYPE"]=="radio" || $Question["TEST_TYPE"]=="check"){?>
                            ...
                            <?if($Question["TEST_TYPE"]=="radio"){?>
                                <input type="radio" <?if($Answer["CHECKED"]=="Y"){?>checked="checked"<?}?> name="answer[<?=$Question["ID"]?>]" value="<?=$Answer["ID"]?>">
                            <?}else{?>
                                <input type="checkbox" <?if($Answer["CHECKED"]=="Y"){?>checked="checked"<?}?> name="answer[<?=$Question["ID"]?>][]" value="<?=$Answer["ID"]?>">
                            <?}?>
                            <div class="right">
                        <?}?>

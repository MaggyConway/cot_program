...
$ListItem="/bitrix/admin/aelita.test.question.group.list.php?lang=";
$EditItem="/bitrix/admin/aelita.test.question.group.edit.php?lang=";
...
$arTest = AelitaTestEditToolEx::GetByID_admin($TEST_ID, 'question_group');
if (!$arTest)
{
...
if ($TEST_ID>0)
{
    ...
    $resTest=$elTest->GetByID($TEST_ID);
    if($test=$resTest->GetNext())
    {
        $MULTIPLE_QUESTION=$test["MULTIPLE_QUESTION"];
    }
}
...
?>
	...
	<tr>
		<td width="30%"><?echo GetMessage("AT_COUNT")?>:</td>
		<td width="70%">
			<input type="text" name="COUNT" size="50" value="<?=$str_COUNT?>">
		</td>
	</tr>
	<tr>

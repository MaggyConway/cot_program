...
$EditItem="aelita.test.question.group.edit.php";
...
$arHeaders[]=array("id"=>"COUNT","content"=>GetMessage("AT_COUNT"), "sort"=>"", "default"=>true);
...
while ($arExtra = $dbResultList->NavNext(true, "f_"))
{
	...
	else
	{
		...
		$row->AddInputField("COUNT", array("size" => "25"));
